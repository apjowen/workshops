...
1. Go to the Zenodo website and create an account if you don't already have one.

2. Click the "Upload" button in the top right corner of the Zenodo homepage.
